...
let setGameOver = () =>{
    ...
    resetButton.style.backgroundColor = '' //в значение этой кнокпи записываем начать новую игру
    document.querySelector('.guess-number').appendChild(resetButton) //помещаем данные кнопку в body через appendChild
